...
if __name__ == '__main__':
    ...
    axis_1.plot_date(date_for_plot.plot_date, intensity_sun, label='sun intensity', color='k', linestyle='--', marker='None')
    ...
    axis_2 = axis_1.twinx()
    axis_2.plot_date(date_for_plot.plot_date, alt, color='r', label='Sun', linestyle='-', marker='None')
