...
if __name__ == '__main__':
    ...
    for i in range(time_intervals.shape[0]):
        ...
        alt_sun[i] = temp.alt.to('deg')

    sky_darkness = (1 - compute_moon_intensity(alt, phases)) * (1 - compute_sun_intensity(alt_sun))
